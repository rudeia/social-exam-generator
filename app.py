...
CURRICULUM_DB = [
    {
        ...
        "skill_attitude": """(과정) 탐구 주제의 역사적 배경 조사하기 
...
(가치) 시간적, 공간적, 사회적, 윤리적 차원의 다양한 쟁점에 관한 관심""",
    ...
    },
    {
        ...
        "core_idea": """시간적, 공간적, 사회적, 윤리적 측면을 함께 고려하는 통합적 관점의 적용을 통해 인간, 사회, 환경의 특성 및 관련 문제를 잘 파악할 수 있다.""",
        "knowledge": """·통합적 관점 ·시간적 관점 ·공간적 관점 ·사회적 관점 ·윤리적 관점""",
        "skill_attitude": """(과정) 통합적 관점에서 해결 방안을 도출하고 타당성 평가하기 
...
(가치) 갈등 해결을 위한 타인과의 소통과 협력""",
    ...
    },
    {
        ...
        "skill_attitude": """(과정) 주제와 관련된 다양한 가치를 통합적 관점에서 이해하고 가치 간의 관계 탐구하기 
...
(가치) 타인의 삶의 방식과 문화에 대한 이해와 존중""",
    ...
    },
    {
        ...
        "core_idea": """질 높은 정주 환경의 조성, 경제적 안정, 민주주의의 실현, 윤리적 실천은 행복한 삶을 위한 중요한 조건이다.""",
        "knowledge": """행복의 의미, 행복의 조건""",
        "skill_attitude": """(과정) 탐구 주제에 적합한 자료를 수집 및 분석하기 
...
(가치) 공동체의 문제 및 위기 해결 과정에 대한 적극적 참여""",
    ...
    },
    {
        ...
        "core_idea": """자연환경과 인간 생활의 유기적 관계를 고려하는 생태시민의 태도가 자연과 인간의 공존을 가능하게 한다.""",
        "knowledge": """자연관""",
        "skill_attitude": """(과정) 갈등 상황에서 가치를 선택하고 그 결과를 예측 및 평가하기
...
(가치) 생태·평화적 관점에서 공존과 지속가능한 발전을 지향하는 태도""",
    ...
    },
    {
        ...
        "knowledge": """문화권""",
        "skill_attitude": """(과정) 탐구 주제를 그림이나 지도, 도식 등을 활용하여 분석하고 표현하기
...
(가치) 다양한 생활방식과 문화에 대한 이해와 존중""",
    ...
    },
    {
        ...
        "core_idea": """다양성 존중의 태도는 서로 다른 문화권과 다문화 사회의 특성을 이해하는 바탕이 된다.""",
        "knowledge": """다문화 사회""",
        "skill_attitude": """(과정) 민주적 절차와 방법을 활용하여 합의 도출하기
...
(가치) 공동체 문제 해결을 위한 적극적 참여와 공동선의 실천""",
    ...
    },
    {
        ...
        "skill_attitude": """(과정) 탐구 주제를 그림, 지도, 도식 등을 활용하여 분석하고 표현하기
...
(가치) 지역적, 국가적, 세계적 수준의 다양한 쟁점에 관한 관심""",
    ...
    },
    {
        ...
        "core_idea": """생활공간과 생활양식의 변화로 나타난 문제를 해결하려는 시민의 실천을 통해 지역사회의 변화를 이끌어낼 수 있다.""",
        "knowledge": """지역사회""",
        "skill_attitude": """(과정) 탐구 대상에 대한 현장조사 수행하기
...
(가치) 민주적 절차를 존중하는 과정에서 사회적 소수자 배려""",
    ...
    },
    {
        ...
        "skill_attitude": """(과정) 주제와 관련된 다양한 가치를 통합적 관점에서 이해하기
...
(가치) 타인의 감정 이해 및 가치와 태도 존중""",
    ...
    },
    {
        ...
        "core_idea": """정의의 의미와 기준을 이해하고, 이에 대한 실천 방안을 모색함으로써 사회 불평등 문제 해결에 기여할 수 있다.""",
        "knowledge": """정의관""",
        "skill_attitude": """(과정) 갈등 상황에서 가치를 선택하고 그 결과를 예측 평가하기
...
(가치) 타인의 감정 이해 및 타인의 가치 존중""",
    ...
    },
    {
        ...
        "skill_attitude": """(과정) 주제와 관련된 가치를 통합적 관점에서 이해하기
...
(가치) 시간적, 공간적, 사회적 쟁점에 관한 관심""",
    ...
    },
    {
        ...
        "core_idea": """경제 주체들은 효율성을 기준으로 경제활동에 참여하며, 문제 해결을 위해 지속가능발전을 추구한다.""",
        "knowledge": """국제 분업과 무역""",
        "skill_attitude": """(과정) 그림이나 지도, 도식 등을 활용하여 분석하고 표현하기
...
(가치) 세계적 쟁점에 관한 관심""",
    ...
    },
    {
        ...
        "knowledge": """세계화""",
        "skill_attitude": """(과정) 탐구 주제를 나-지역-국가-세계의 관계 속에서 파악하기
...
(가치) 지구촌 공동체의 문제 해결에 대한 적극적 참여""",
    ...
    },
    {
        ...
        "skill_attitude": """(과정) 갈등 상황에서 가치를 선택하고 결과 예측 및 평가하기
...
(가치) 공존과 지속가능한 발전을 지향하는 태도""",
    ...
    },
    {
        ...
        "skill_attitude": """(과정) 그림이나 지도, 도식 등을 활용하여 분석하기
...
(가치) 지구촌 공동체 위기 해결에 대한 적극적 참여""",
    ...
    },
    {
        ...
        "skill_attitude": """(과정) 주제에 적합한 자료 수집 및 분석
...
(가치) 생태·평화적 관점에서 공존을 지향하는 태도""",
    ...
    },
    {
        ...
        "skill_attitude": """(과정) 탐구 주제를 나-지역-국가-세계 관계 속에서 파악하기
...
def get_subjects():
    """과목 목록"""
    return sorted(list(set(item["subject"] for item in CURRICULUM_DB)))

def get_units(subject=None):
    """대단원 목록 (중복 제거)"""
    seen = set()
    units = []
...
def get_standards(unit=None, subject=None):
    """성취기준 목록"""
    results = []
    for item in CURRICULUM_DB:
...
def format_standard_label(item):
    """성취기준 표시용 라벨"""
    short = item["standard"][:50] + "..." if len(item["standard"]) > 50 else item["standard"]
...
def call_gemini(prompt, image=None):
    ...
    for attempt in range(max_retries):
        ...
        try:
            ...
            if any(kw in error_msg.lower() for kw in [
                ...
                st.warning(f"⚠️ 키 #{key_num} 용량 초과 → 다음 키로 전환...")
                ...
                "401", "403", "invalid", "api_key", "api key"
            ]):
                st.warning(f"⚠️ 키 #{key_num} 인증 실패 → 다음 키로 전환...")
                km.mark_failed(current_key)
    ...
    return None, f"모든 키 소진! ({last_error}). 새 API 키를 추가해주세요."
...
with st.sidebar:
    ...
    st.caption("최대 5개 입력 가능 · 용량 초과 시 자동 전환")

    keys_input = []
    for i in range(5):
        label = f"API 키 #{i+1}" + (" (필수)" if i == 0 else " (선택)")
        key = st.text_input(
            label,
            type="password",
            key=f"api_key_{i}",
    ...
    valid_keys = [k for k in keys_input if k and len(k.strip()) > 10]

    if valid_keys:
        st.session_state.key_manager.set_keys(valid_keys)
        ...
        if total >= 2:
            ...
            st.info("ℹ️ 1개 등록됨 (추가 등록 권장)")
    else:
        st.warning("⬆️ API 키를 1개 이상 입력하세요")

    st.divider()
    st.markdown("### 💡 무료 API 키 만들기")
    st.markdown("[Google AI Studio](https://aistudio.google.com) 접속 → Get API Key")

# ============================================
# 메인 타이틀
# ============================================
st.title("📚 통합사회 유사 문항 출제기")
st.caption("2022 개정 교육과정 | 고등학교 통합사회 1·2 | Gemini AI 기반")
...
with tab1:
    ...
    with col_left:
        ...
        uploaded_file = st.file_uploader("문항 이미지를 선택하세요", type=["png", "jpg", "jpeg"], key="tab1_upload")
    ...
    with col_right:
        # 성취기준 지정 옵션
        use_standard = st.checkbox("특정 성취기준 지정하기", key="tab1_use_std")
        selected_std_info = ""

        if use_standard:
            subject_sel = st.selectbox("과목 선택", get_subjects(), key="tab1_subj")
            units = get_units(subject=subject_sel)
            unit_sel = st.selectbox("대단원 선택", [u["unit"] for u in units], key="tab1_unit")
            standards = get_standards(unit=unit_sel, subject=subject_sel)
            std_labels = [format_standard_label(s) for s in standards]
            std_sel = st.selectbox("성취기준 선택", std_labels, key="tab1_std")

            if std_sel:
                std_id = std_sel.split("]")[0].replace("[", "").strip()
                std_data = get_standard_by_id(std_id)
                if std_data:
                    with st.expander("📋 성취기준 상세 정보"):
                        st.markdown(f"**성취기준:** {std_data['standard']}")
                        st.markdown(f"**핵심 아이디어:** {std_data['core_idea']}")
                        st.markdown(f"**AI 출제 가이드:** {std_data['ai_guide']}")

                    selected_std_info = f"""
[성취기준 정보]
- ID: {std_data['id']}
- 성취기준: {std_data['standard']}
- 핵심 아이디어: {std_data['core_idea']}
- 지식·이해: {std_data['knowledge']}
- AI 출제 가이드: {std_data['ai_guide']}
"""

        if st.button("🚀 유사 문항 생성", type="primary", use_container_width=True, key="tab1_btn"):
            if not uploaded_file:
                ...
                with st.spinner("🔄 AI가 문항을 분석하고 유사 문항을 생성 중..."):
                    prompt = f"""당신은 대한민국 고등학교 통합사회 시험 문항 출제 전문가입니다.

업로드된 시험 문항 이미지를 분석하고, 동일한 형식과 난이도로 유사한 문항 2개를 만들어주세요.

{selected_std_info}

[출제 조건]
1. 원본 문항의 형식(5지선다, 표/그래프 활용 등)을 유지할 것
2. 동일한 성취기준·개념을 평가하되, 소재와 자료는 다르게 할 것
3. 난이도는 원본과 비슷하게 유지할 것
4. 각 문항마다 정답과 해설을 포함할 것
...
"""
                    image = Image.open(uploaded_file)
                    result, error = call_gemini(prompt, image=image)

                    if error:
                        st.error(f"❌ {error}")
                    else:
                        st.success("✅ 유사 문항 생성 완료!")
                        st.markdown("---")
                        st.markdown(result)
...
with tab2:
    ...
    with col_left2:
        ...
        # 과목 선택
        subject2 = st.selectbox("📘 과목 선택", get_subjects(), key="tab2_subj")

        # 대단원 선택
        units2 = get_units(subject=subject2)
        unit2 = st.selectbox("📖 대단원 선택", [u["unit"] for u in units2], key="tab2_unit")

        # 성취기준 선택
        standards2 = get_standards(unit=unit2, subject=subject2)
        std_labels2 = [format_standard_label(s) for s in standards2]
        std2 = st.selectbox("🎯 성취기준 선택", std_labels2, key="tab2_std")

        # 선택된 성취기준 상세 표시
        if std2:
            std_id2 = std2.split("]")[0].replace("[", "").strip()
            std_data2 = get_standard_by_id(std_id2)

            if std_data2:
                with st.expander("📋 성취기준 상세 정보", expanded=True):
                    st.markdown(f"**📌 성취기준:** {std_data2['standard']}")
                    st.markdown(f"**💡 핵심 아이디어:** {std_data2['core_idea']}")
                    st.markdown(f"**📚 지식·이해:** {std_data2['knowledge']}")
                    st.markdown(f"**🔧 과정·기능/가치·태도:** {std_data2['skill_attitude']}")
                    st.markdown(f"**📖 해설:** {std_data2['explanation']}")
                    st.markdown(f"**⚠️ 고려사항:** {std_data2['consideration']}")
                    st.markdown(f"**🤖 AI 가이드:** {std_data2['ai_guide']}")
        ...
        # 문항 수
        num_questions = st.slider("문항 수", 1, 5, 2, key="tab2_num")

        # 문항 유형
        q_type = st.multiselect(
            "문항 유형",
            ["5지선다", "OX 판단", "빈칸 채우기", "자료 분석", "표/그래프 해석", "사례 적용"],
            default=["5지선다"],
            key="tab2_type"
        )

    with col_right2:
        if st.button("🚀 문항 자동 출제", type="primary", use_container_width=True, key="tab2_btn"):
            if not valid_keys:
                st.error("❌ API 키를 입력해주세요")
            elif not std2:
                ...
                if std_data2:
                    with st.spinner("🔄 AI가 성취기준 기반 문항을 출제 중..."):
                        prompt = f"""당신은 대한민국 고등학교 통합사회 시험 문항 출제 전문가입니다.

아래 성취기준 정보를 바탕으로 문항을 출제해주세요.

[성취기준 정보]
- 코드: {std_data2['id']}
- 과목: {std_data2['subject']}
- 대단원: {std_data2['unit']}
- 성취기준: {std_data2['standard']}
- 핵심 아이디어: {std_data2['core_idea']}
- 지식·이해: {std_data2['knowledge']}
- 과정·기능/가치·태도: {std_data2['skill_attitude']}
- 성취기준 해설: {std_data2['explanation']}
- 적용 시 고려사항: {std_data2['consideration']}
- AI 출제 가이드: {std_data2['ai_guide']}

[출제 조건]
- 난이도: {difficulty}
- 문항 수: {num_questions}개
- 문항 유형: {', '.join(q_type)}
- 2022 개정 교육과정 통합사회 수준에 맞출 것
- 각 문항마다 정답과 상세 해설을 포함할 것
- 실제 수능/모의고사 스타일로 출제할 것
...
**정답:** ①
**해설:** (상세 해설 - 왜 정답인지, 오답 선택지 분석 포함)
**관련 성취기준:** {std_data2['id']}
...
"""
                        ...
                        if error:
                            ...
                            st.success(f"✅ {num_questions}개 문항 출제 완료!")
                            st.markdown("---")
                            st.markdown(result)
...
with tab3:
    ...
    with col_left3:
        ...
        uploaded_file3 = st.file_uploader("문항 이미지를 선택하세요", type=["png", "jpg", "jpeg"], key="tab3_upload")
    ...
    with col_right3:
        st.subheader("적용할 성취기준")

        subject3 = st.selectbox("📘 과목 선택", get_subjects(), key="tab3_subj")
        units3 = get_units(subject=subject3)
        unit3 = st.selectbox("📖 대단원 선택", [u["unit"] for u in units3], key="tab3_unit")

        standards3 = get_standards(unit=unit3, subject=subject3)
        std_labels3 = [format_standard_label(s) for s in standards3]
        std3 = st.selectbox("🎯 성취기준 선택", std_labels3, key="tab3_std")

        if std3:
            std_id3 = std3.split("]")[0].replace("[", "").strip()
            std_data3 = get_standard_by_id(std_id3)
            if std_data3:
                with st.expander("📋 성취기준 상세"):
                    st.markdown(f"**성취기준:** {std_data3['standard']}")
                    st.markdown(f"**AI 가이드:** {std_data3['ai_guide']}")

        if st.button("🚀 교차 문항 생성", type="primary", use_container_width=True, key="tab3_btn"):
            if not uploaded_file3:
                st.error("❌ 이미지를 업로드해주세요")
            elif not valid_keys:
                st.error("❌ API 키를 입력해주세요")
            elif not std3:
                ...
                if std_data3:
                    with st.spinner("🔄 AI가 교차 문항을 생성 중..."):
                        prompt = f"""당신은 대한민국 고등학교 통합사회 시험 문항 출제 전문가입니다.

업로드된 시험 문항의 **형식과 구조**를 분석하고,
아래 **다른 성취기준의 내용**으로 같은 형식의 새 문항을 만들어주세요.

[적용할 성취기준]
- 코드: {std_data3['id']}
- 대단원: {std_data3['unit']}
- 성취기준: {std_data3['standard']}
- 핵심 아이디어: {std_data3['core_idea']}
- 지식·이해: {std_data3['knowledge']}
- 해설: {std_data3['explanation']}
- AI 출제 가이드: {std_data3['ai_guide']}

[출제 조건]
1. 원본 이미지의 문항 형식(5지선다, 표, 그래프 등)을 그대로 따를 것
2. 내용은 위 성취기준에 맞게 완전히 새로 작성할 것
3. 유사 문항 2개를 만들 것
4. 각 문항마다 정답과 해설 포함
...
"""
                        image3 = Image.open(uploaded_file3)
                        result, error = call_gemini(prompt, image=image3)

                        if error:
                            st.error(f"❌ {error}")
                        else:
                            st.success("✅ 교차 문항 생성 완료!")
                            st.markdown("---")
                            st.markdown(result)
...
with col_info1:
    st.markdown(f"📊 **성취기준 DB:** {len(CURRICULUM_DB)}개")
with col_info2:
    st.markdown(f"📘 **대단원:** {len(get_units())}개")
with col_info3:
    total, active, failed = st.session_state.key_manager.get_status()
    st.markdown(f"🔑 **API 키:** {active}/{total}개 활성")
